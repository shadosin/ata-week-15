package com.kenzie.photo.converter.concurrent;

import com.kenzie.photo.converter.PrimePhotoConverter;
...
public class ConcurrentConverter implements Runnable {
    ...
    public ConcurrentConverter(final PrimePhotoConverter converter,
                               final PrimePhoto inputImage,
