...
public class PasswordCracker {
     ...
     * @param args input to the Java program
     * @throws InterruptedException when the PasswordHasher is interrupted while generating all hashes.
     */
    public static void main(String[] args) throws InterruptedException {
        ...
        for (Map.Entry<String, String> passwordToHash : passwordToHashes.entrySet()) {
            ...
            if (hackedHashToUserIds.containsKey(hash)) {
                ...
                System.out.println(String.format("Users %s are using the password %s", hackedHashToUserIds.get(hash),
                        password));
            }
        }
